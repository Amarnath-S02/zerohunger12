      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/4 mb-6">
            <h5 className="font-bold text-lg mb-4">Zero Hunger</h5>
            <p className="text-sm">
              Our mission is to end malnutrition by eliminating food wastage. We connect food donors with recipients to ensure that surplus food reaches those in need.
            </p>
          </div>
          <div className="w-full md:w-1/4 mb-6">
          ...
          <div className="w-full md:w-1/4 mb-6">
            ...
            <ul>
              <li className="mb-2">
                <a href="#" className="text-sm hover:text-gray-400">Blog</a>
              </li>
              <li className="mb-2">
                <a href="#" className="text-sm hover:text-gray-400">FAQs</a>
              </li>
              <li className="mb-2">
                <a href="#" className="text-sm hover:text-gray-400">Support</a>
              </li>
              <li className="mb-2">
          ...
          <div className="w-full md:w-1/4 mb-6">
            ...
            <p className="text-sm mb-2">123 Main Street, Anytown, USA</p>
            <p className="text-sm mb-2">Email: info@zerohunger.com</p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center">
          <p className="text-sm">&copy; 2024 Zero Hunger. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
